...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_truwls4', 'template_ihnmwh9', { from_name: form.name, to_name: 'Mayank', from_email: form.email, to_email: 'iammayank1628@gmail.com', message: form.message }, 'JTl2Y5mVpGxbadxFa')
